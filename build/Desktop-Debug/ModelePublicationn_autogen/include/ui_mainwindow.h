...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        layoutWidget->setGeometry(QRect(20, 50, 662, 611));
        ...
        layoutWidget1->setGeometry(QRect(1110, 50, 662, 611));
        ...
        label_4->setGeometry(QRect(710, 120, 371, 41));
        label_4->setAlignment(Qt::AlignCenter);
        splitter_2 = new QSplitter(centralwidget);
        splitter_2->setObjectName("splitter_2");
        splitter_2->setGeometry(QRect(710, 430, 371, 91));
        ...
        layoutWidget2->setGeometry(QRect(710, 170, 371, 261));
        ...
        widget->setGeometry(QRect(710, 550, 371, 61));
        ...
        gridLayout_2->addWidget(btnPublier, 0, 0, 1, 1);
        ...
        gridLayout_2->addWidget(btnSupprimer, 0, 1, 1, 1);
        ...
        gridLayout_2->addWidget(btnSauvegarder, 0, 2, 1, 1);
